...
description: >
  Remove AI writing patterns from prose (microcopy, landing copy, docs, reports).
  Triggers: stop slop prose, edit copy, AI writing tells, humanize text.
  Not for visual UI craft — use ANTI-SLOP.md for that.
metadata:
